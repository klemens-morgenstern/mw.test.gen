...
x3::rule<class call_trace_decl_doc, data::call_trace_decl> const call_trace_decl_doc;
x3::rule<class stub_doc, data::stub> const stub_doc;
x3::rule<class fake_doc, data::fake> const fake_doc;
