...
int test_main (int, char**)
{
	...
	BOOST_CHECK(res);
	BOOST_CHECK(itr == end);
	BOOST_CHECK(uf.type == d::use_file_type::file);
	...
	BOOST_CHECK(uf.type == d::use_file_type::include);
	...
	BOOST_CHECK(uf.type == d::use_file_type::tests_file);
	...
	s = "/*! pre doc */ tests_file i.ipp; //!< post doc\n";
